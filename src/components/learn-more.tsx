  ...
  return (
    <section className="py-14">
      <Container>
        ...
        <ul className="flex list-inside flex-col justify-center gap-6 md:flex-row md:gap-10">
          <li className="flex items-center space-x-2">
            <Leaf size={20} fill="#2f7b5d" />
            <a
              href="https://todoist.com/productivity-methods/pomodoro-technique"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full rounded-full border-2 border-[#afaa93] bg-[#f9faf0] px-4 py-2 text-sm text-gray-800 duration-200 hover:bg-[#afaa93]"
            >
